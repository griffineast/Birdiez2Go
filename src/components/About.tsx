  ...
  return (
    <section id="about" className="py-20 sm:py-32 bg-fairway/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Left side — slides between intro and detail */}
          ...
          <motion.div variants={slideInRight} className="flex flex-col gap-4">
            ...
            <button
              ...
              className="bg-gold/10 border border-gold/30 text-gold font-semibold px-6 py-3 rounded-full text-sm uppercase tracking-wider hover:bg-gold hover:text-forest transition-all duration-300"
            >
              {showDetail
                ? "\u2190 Back to About"
